...
function instance(model, serializer) {
  ...
  model
    ...
    .action('find', find)
      ...
      .param('type').format('filter', 'instance-type')
      .param('key').format('filter', 'key-name')
      .param('isWindows').format('filter', 'platform')
