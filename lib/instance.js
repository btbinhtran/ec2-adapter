...
exports.find = function(context, data, fn){
  context.ec2.call('DescribeInstances', {}, function(err, result){
    ...
    if (!result.reservationSet.item) return fn(null, []);

    result.reservationSet.item.forEach(function(i){
      instance = {
...
exports.remove = function(id, fn){
  ...
  context.ec2.call('TerminateInstances', { 'InstanceId.1': id }, function(err, result){
    fn(err, result);
  });
}
